...
from torchkde.modules import KernelDensity  # this is, itself, a torch.nn.module
from ..utils.indexing import IndexesMethodPair
from ..utils.constants import KB, DEFAULT_STRATEGIES
...
class ChemicalLoss(ABC):
    ...
    def find_valid_pairs(
        ...
        exclude_residue_names = exclude_residue_names or list(DEFAULT_STRATEGIES)
